System.config({
  ...
  map: {
    ...
    "npm:cross-spawn@2.1.0": {
      "cross-spawn-async": "npm:cross-spawn-async@2.1.1",
      "process": "github:jspm/nodelibs-process@0.1.2",
    ...
    "npm:gulp-if@2.0.0": {
      "gulp-match": "npm:gulp-match@1.0.0",
      "ternary-stream": "npm:ternary-stream@2.0.0",
    ...
    "npm:gulp-jspm@0.5.5": {
      ...
      "mini-assert": "npm:mini-assert@1.0.7",
      "path": "github:jspm/nodelibs-path@0.1.0",
      "systemjs-json": "github:systemjs/plugin-json@0.1.0",
      "temp": "npm:temp@0.8.3",
      "through2": "npm:through2@2.0.0",
    ...
    "npm:gulp-livereload@3.8.1": {
      ...
      "mini-lr": "npm:mini-lr@0.1.8",
      "path": "github:jspm/nodelibs-path@0.1.0",
      "process": "github:jspm/nodelibs-process@0.1.2"
    },
    "npm:gulp-match@1.0.0": {
      "minimatch": "npm:minimatch@3.0.0"
    },
    "npm:gulp-next@1.0.4": {
      "through-gulp": "npm:through-gulp@0.3.8"
    },
    "npm:gulp-sass@2.1.1": {
      "gulp-util": "npm:gulp-util@3.0.7",
    ...
    "npm:gulp-webserver@0.9.1": {
      "connect": "npm:connect@3.4.0",
      "connect-livereload": "npm:connect-livereload@0.4.1",
      "fs": "github:jspm/nodelibs-fs@0.1.2",
      ...
      "open": "npm:open@0.0.5",
      "path": "github:jspm/nodelibs-path@0.1.0",
      "proxy-middleware": "npm:proxy-middleware@0.5.1",
      "serve-index": "npm:serve-index@1.7.2",
      "serve-static": "npm:serve-static@1.10.0",
      "through2": "npm:through2@0.5.1",
      "tiny-lr": "npm:tiny-lr@0.1.4",
      "url": "github:jspm/nodelibs-url@0.1.0",
      "watch": "npm:watch@0.11.0"
    },
    "npm:gulp@3.9.0": {
    ...
    "npm:node-sass@3.4.2": {
      ...
      "chalk": "npm:chalk@1.1.1",
      "cross-spawn": "npm:cross-spawn@2.1.0",
      "fs": "github:jspm/nodelibs-fs@0.1.2",
      "gaze": "npm:gaze@0.5.2",
      "get-stdin": "npm:get-stdin@4.0.1",
      "glob": "npm:glob@5.0.15",
